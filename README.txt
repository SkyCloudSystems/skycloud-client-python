...
1) Download and install Qt 4.8 for Mac OS X: wiki.qt.io/PySide_Binaries_MacOSX
   If you have El Capitan, use Homebrew: brew install qt
2) If you do not have Python 2.7.x, install pip: sudo easy_install pip
3) Install PySide: sudo pip install pyside
